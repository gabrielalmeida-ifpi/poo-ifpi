...
class App {
    ...
    public bloquearPerfil(): void {
        ...
        let idBloqueando: number = +input("Digite o Id de quem está bloqueando: ")
        let perfilBloqueando: Perfil = <Perfil>redeSocial.consultarPerfil(idBloqueando)
